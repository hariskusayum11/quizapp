...
class _QuizScreenState extends State<QuizScreen> {
  ...
  void _playEntrySound() {
    audioPlayer.play(AssetSource('entry_sound.mp3'));
  }
                  ...
                  child: Padding(
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          Text(
                            "คำถามที่ $_questionNumber/${widget.questionlenght.length}",
                            style: TextStyle(
  ...
  @override
  void dispose() {
    audioPlayer.dispose(); // Dispose of AudioPlayer to avoid memory leaks
    super.dispose();
  }
}
